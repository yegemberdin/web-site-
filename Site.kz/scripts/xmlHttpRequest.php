...
return stripslashes($nStr);
	...
	$mailit = mail($to,$subject,$message,$headers);
		...
		if ( @$mailit )
		{ $posStatus = 'OK'; $posConfirmation = 'Ваше письмо успешно отправлено!'; }
		else
		{ $posStatus = 'NOTOK'; $posConfirmation = 'Ваше письмо не отправлено. Пожалуйста, попытайтесь в другой раз'; }
